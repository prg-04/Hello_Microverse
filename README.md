...
- Login to your github account and search for 'prg-04/Hello_Microverse'
...
- After cloning the repository change the directory using 'cd Hello_Microverse' to access the files.
...
- In your terminal window type: git clone https://github.com/prg-04/Hello_Microverse.git

### Usage

To run the project, execute the following command:

- code Hello_Microverse .
...
Feel free to check the [issues page](https://github.com/prg-04/Hello_Microverse/issues).
